				...
				<ul class="metismenu mm-show" id="menu">
					...
					<li class="mm-active"><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
					 ...
					 <li class="mm-active"><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
						...
						<span class="nav-text">Asset And Accessory</span>
						</a>
						<ul aria-expanded="false" class="mm-collapse mm-show left" style="">
							<li class="mm-active"><a href="assets-list">Assets</a></li>
							<li class="mm-active"><a href="asset-assignment-list">Asset Assignment</a></li>
							<li><a href="accessories-list">Accessory</a></li>
							<li><a href="accessory-issue-list">Accessory Issue List</a></li>
						</ul>
					</li>
					  <li class="mm-active"><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
						<div class="menu-icon">
						...
						<ul aria-expanded="false" class="mm-collapse mm-show left" style="">
							<li class="mm-active"><a href="asset-type-list">Asset Type</a></li>
							<li><a href="accessory-type-list">Accessory Type</a></li>	
							<li><a href="parent-type-list">Parent Type</a></li>	
						</ul>
					</li>	 
			</div>
        </div> 
